...
import { getPersonById } from 'apiSdk/people';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('person', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/people/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('expense', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/expenses/create?person_id=${data?.id}`}>
